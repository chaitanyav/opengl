...
std::string crossStichCurveLSystemRepresentation() {
...
int main(int argc, char *argv[]) {
  ...
  window = glfwCreateWindow(vidmode->width, vidmode->height, "Cross-Stich Curve", monitor, NULL);
  if(!window) {
    glfwTerminate();
    return -1;
  }
  ...
  std::string lrep = crossStichCurveLSystemRepresentation();
